...
export default function EnergyDashboard() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 text-gray-100 p-8">
      <div className="max-w-7xl mx-auto"> {/* Changed to max-w-7xl for a wider layout fitting both columns */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Left Column (2/3 width on large screens): Existing Form + Output display */}
          ...
          {/* Right Column (1/3 width on large screens): The Bedrock Co-Pilot */}
